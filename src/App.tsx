...
export default function App() {
  ...
  const recordPayment = async (sendWhatsApp: boolean = false) => {
    ...
    try {
      ...
      if (sendWhatsApp) {
        // WhatsApp Message
        const message = `✅ *ÖDEME DEKONTU - ARİFLER VELİ TAKİP*\n\n` +
  ...
  const sendReminder = (debtor: Debtor) => {
    ...
    const message = `⚠️ *BORÇ HATIRLATMA - ARİFLER VELİ TAKİP*\n\n` +
              ...
              {debtors.filter(d => d.remainingAmount > 0).map(debtor => {
                ...
                return (
                  <div key={debtor.id} className="p-6 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-stone-50 transition-colors gap-4">
                    ...
                    >
                      <MessageSquare size={18} /> Hatırlatma Gönder
                    </button>
                  </div>
                );
              })}
            ...
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <MessageSquare size={20} /> Ödemeyi Onayla ve WhatsApp'tan Gönder
                  </button>
                </div>
              </div>
            </motion.div>
